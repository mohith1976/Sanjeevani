  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../public/admit_patient.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link " href="../public/ward_management.php">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-credit-card text-success text-sm opacity-10"></i>
            </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-body px-0 pt-0 pb-2">
              ...
              <div class="main">
<div class="container">
    <a href="enroll.php" class="btn btn-primary">Add Patient</a>
    <!-- Card to show count -->
</div>
...
<!-- Initialize DataTables and AJAX Update -->
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.data && Array.isArray(response.data)) {
                        ...
                        // Update entry count
                        $('#entryCount').text(response.count);
