              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="<?php echo htmlspecialchars($user->name); ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Email address</label>
                    <input class="form-control" type="email" value="<?php echo htmlspecialchars($user->email); ?>">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="Delhi">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="534186">
                  </div>
                </div>
              </div>
              <hr class="horizontal dark">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="Sanjeevani+ recognized hospital">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="card card-profile">
            ...
            <div class="card-body pt-0">
              ...
              <div class="text-center mt-4">
                <h5>
                <?php echo htmlspecialchars($user->name); ?><span class="font-weight-light"> - <?php echo htmlspecialchars($user->login_code); ?></span>
                </h5>
                <div class="h6 font-weight-300">
                  <i class="ni location_pin mr-2"></i>New Delhi
                </div>
                <div class="h6 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>Multi Speciality Hospital  - New Delhi
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i>NIC Integrated
                </div>
              </div>
            </div>
          </div>
